...
type IndexServiceClient interface {
	...
	AddDoc(ctx context.Context, in *doc.Document, opts ...grpc.CallOption) (*AffectedCount, error)
...
func (c *indexServiceClient) AddDoc(ctx context.Context, in *doc.Document, opts ...grpc.CallOption) (*AffectedCount, error) {
	out := new(AffectedCount)
...
func (UnimplementedIndexServiceServer) AddDoc(context.Context, *doc.Document) (*AffectedCount, error) {
...
func _IndexService_AddDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexServiceServer).AddDoc(ctx, req.(*doc.Document))
	}
	return interceptor(ctx, in, info, handler)
}
